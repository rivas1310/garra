...
export class ShippingService {
  ...
  async getShippingQuotes(request: ShippingQuoteRequest): Promise<ShippingQuoteResult> {
    try {
      ...
      console.log(`🚚 Usando servicio de envío: ${service}`);
      ...
      if (service === 'envioclick') {
        ...
        const enviosPerrosPayload = {
          ...
          'origin-codePostal': request.origin_postal_code,
          'destination-codePostal': request.destination_postal_code
        };
  ...
  async createShippingOrder(request: ShippingOrderRequest): Promise<ShippingOrderResult> {
    try {
      ...
      console.log(`🚚 Usando servicio de envío para crear orden: ${service}`);
